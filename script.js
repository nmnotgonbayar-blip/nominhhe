...
const listingsData = {
    hotels: [
        { id: "h1", loc_id: "terelj", price: 280000, img: "https://images.unsplash.com/photo-1564501049412-61c2a3083791?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "hotel_terelj_name", locKey: "loc_terelj", descKey: "hotel_terelj_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>', reviews: 89, unitKey: "per_night" },
        ...
        { id: "h3", loc_id: "khamar", price: 120000, img: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "hotel_khamar_name", locKey: "loc_khamar", descKey: "hotel_khamar_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i><i class="fa-regular fa-star"></i>', reviews: 45, unitKey: "per_night" },
    ...
    gers: [
        { id: "g1", loc_id: "terelj", price: 80000, img: "https://images.unsplash.com/photo-1596394516093-501ba68a0ba6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "ger_terelj_name", locKey: "loc_terelj", descKey: "ger_terelj_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>', reviews: 210, unitKey: "per_night" },
    ...
    cabins: [
        { id: "c1", loc_id: "terelj", price: 250000, img: "https://images.unsplash.com/photo-1510798831971-661eb04b3739?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "cabin_terelj_name", locKey: "loc_terelj", descKey: "cabin_terelj_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 112, unitKey: "per_night" },
        ...
        { id: "c4", loc_id: "khyargas", price: 280000, img: "https://images.unsplash.com/photo-1449844908441-8829872d2607?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "cabin_khyargas_name", locKey: "loc_khyargas", descKey: "cabin_khyargas_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 92, unitKey: "per_night" }
    ],
    cars: [
        { id: "car1", loc_id: "all", price: 150000, img: "https://images.unsplash.com/photo-1533473359331-0135ef1b58bf?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "car_1_name", locKey: "car_1_loc", descKey: "car_1_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 45, unitKey: "per_day" },
        { id: "car2", loc_id: "all", price: 120000, img: "https://images.unsplash.com/photo-1559405628-98e378fc3407?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "car_2_name", locKey: "car_2_loc", descKey: "car_2_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>', reviews: 62, unitKey: "per_day" },
        { id: "car3", loc_id: "all", price: 300000, img: "https://images.unsplash.com/photo-1503376766468-1ebfcb665fa6?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "car_3_name", locKey: "car_3_loc", descKey: "car_3_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 15, unitKey: "per_day" }
    ],
    guides: [
        { id: "guide1", loc_id: "all", price: 80000, img: "https://images.unsplash.com/photo-1544717305-2782549b5136?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "guide_1_name", locKey: "guide_1_loc", descKey: "guide_1_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 88, unitKey: "per_day" },
        { id: "guide2", loc_id: "all", price: 60000, img: "https://images.unsplash.com/photo-1508214751196-bfd143477b75?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "guide_2_name", locKey: "guide_2_loc", descKey: "guide_2_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>', reviews: 54, unitKey: "per_day" },
        { id: "guide3", loc_id: "all", price: 100000, img: "https://images.unsplash.com/photo-1552058544-f2b08422138a?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80", nameKey: "guide_3_name", locKey: "guide_3_loc", descKey: "guide_3_desc", ratingHtml: '<i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>', reviews: 32, unitKey: "per_day" }
    ]
};
